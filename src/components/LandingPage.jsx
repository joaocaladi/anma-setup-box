          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div className="flex flex-col items-center md:items-start">
              ...
              <div className="flex items-center gap-4 mt-6">
                {/* Instagram */}
                <a
                  href="https://www.instagram.com/anma.setups"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-[#424245] hover:text-[#E4405F] transition-colors"
                ...
                {/* Facebook */}
                <a
                  href="https://www.facebook.com/profile.php?id=61551099580230"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-[#424245] hover:text-[#1877F2] transition-colors"
                  aria-label="Facebook"
                >
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                ...
                {/* YouTube */}
                <a
                  href="https://www.youtube.com/channel/UCCXwTA1yeaG5TutnfqdqRYg"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-[#424245] hover:text-[#FF0000] transition-colors"
                  aria-label="YouTube"
                >
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                ...
                {/* TikTok */}
                <a
                  href="https://www.tiktok.com/@anma.setups"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-[#424245] hover:text-[#000000] transition-colors"
                  aria-label="TikTok"
                >
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
